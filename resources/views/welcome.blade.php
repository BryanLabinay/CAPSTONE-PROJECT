                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="box">
                            ...
                            <p>
                                ...
                                Quos fugit sint sit saepe impedit corporis?
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="box">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Commodi facere amet provident quibusdam eos modi!
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                        <div class="box">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Unde similique eum quidem. Unde, aliquam nihil.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        {{-- <section id="features" class="features">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row feture-tabs" data-aos="fade-up">
                    <div class="col-lg-6">
                        <h3>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis fugiat ullam cumque
                            voluptate corrupti facere voluptates deserunt assumenda, eius vitae!
                        </h3>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-1.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-2.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-3.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-4.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-5.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-6.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-7.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ url('assets/img/clients/client-8.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                    </div>
                    <div class="swiper-pagination"></div>
