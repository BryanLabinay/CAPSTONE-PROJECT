...
@section('content_header')
    <h5 class="fw-bolder" style="color: #343984;"><i class="fa-solid fa-caret-right me-2"></i>Email</h5>
        ...
        <form action="{{ route('send.email') }}" method="post">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="email" name="email" class="form-control" id="patient" required>
                </div>
                <div class="col-6">
