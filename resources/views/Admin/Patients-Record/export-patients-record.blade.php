...
<head>
    <title>All Appointment Record PDF</title>
...
<body>
    <header>
        ...
        <p class="title">PATIENTS RECORDS</p>
        {{-- <p>ATTENDANCE FOR STUDENTS LOG SHEET</p> --}}
    </header>
    <footer>
        <div class="div2">
            <p><i>"Where compassion meets care for a healthier tomorrow."</i></p>
        </div>
        <div><small><span class="pagenum"></span></small></div>
    </footer>
    <main>
